...
function Home() {
    ...
    return (
        <div className="flex-1 flex flex-col w-full relative bg-[#0B0F19]">
            ...
            {/* HERO SECTION - Now visible on all screen sizes */}
            <Section className="hero-min-height flex flex-col items-center justify-center pt-24 pb-16 px-6 overflow-hidden border-b border-slate-800">
                ...
                >
                    ...
                    {/* GUIDE BUTTON - Available as primary info link */}
                    <motion.button
                        variants={fadeInUp}
                        onClick={openGuide}
            ...
            {/* FEATURES SECTION - Now visible on all screen sizes */}
            <Section className="bg-[#151B2B]">
                <Container>
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 lg:mb-24 gap-8 text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <Card className="group p-10 lg:p-12 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-none border-t-2 border-t-cyan-500/30 hover:border-t-cyan-500 transition-all text-left relative overflow-hidden">
                        ...
                        <Card className="group p-10 lg:p-12 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-none border-t-2 border-t-amber-500/30 hover:border-t-amber-500 transition-all text-left relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                        ...
                        <Card className="group p-10 lg:p-12 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-none border-t-2 border-t-emerald-500/30 hover:border-t-emerald-500 transition-all text-left relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                                <WifiOff size={120} strokeWidth={1} />
                            </div>
                            <div className="w-16 h-16 bg-emerald-500/10 text-emerald-400 rounded-none flex items-center justify-center mb-10 border border-emerald-500/20 group-hover:scale-110 transition-all duration-500 shadow-[0_0_20px_rgba(16,185,129,0.2)]">
            ...
            <Section className="py-20 border-t border-slate-800 bg-[#0B0F19]">
                <Container className="flex flex-col items-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                        <div className="text-2xl font-black text-slate-100 flex items-center gap-2 uppercase tracking-tighter">
                            <Shield className="text-red-600" size={32} /> RCR PROTECT
                        </div>
                        <div className="text-2xl font-black text-slate-100 flex items-center gap-2 italic uppercase tracking-tighter">
